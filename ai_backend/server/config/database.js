...
try {
  ...
  try {
    // 回退到 pnpm 实际路径
    PrismaClient = require('../../../online-ppt-backend/node_modules/.pnpm/@prisma+client@6.19.1_prism_d4c309513f45d21f4e4aa7921d8002c7/node_modules/.prisma/client').PrismaClient;
  } catch (err2) {
