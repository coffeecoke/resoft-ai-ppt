...
export const questions = [
  { id: 1, title: '系统支持哪些数据库兼容？', category: '数', categoryColor: '#FF6A00', tags: ['国产化', '数据库'], answer: '数据库支持mysql、Oracle[11gR1、12cR2]、DB2、达梦。', date: '2025/10/20', customer: '渤海银行', views: 123, likes: 123, dislikes: 0, comments: 12, userLiked: false, userDisliked: false },
  { id: 2, title: '如何配置容灾与备份？', category: '技', categoryColor: '#9C27B0', tags: ['高可用', '备份'], answer: '系统提供完整的容灾备份方案，支持主备切换、数据同步、定时备份等功能。', date: '2025/10/18', customer: '北京银行', views: 98, likes: 45, dislikes: 0, comments: 8, userLiked: false, userDisliked: false },
  { id: 3, title: 'RSZS如何在个性化场景做扩展？', category: '技', categoryColor: '#9C27B0', tags: ['可扩展性'], answer: 'RSZS可信区个性化分支1.4版本与公司合版已实现功能对接，支持个性化配置和统一管理。', date: '2025/10/15', customer: '上海银行', views: 67, likes: 23, dislikes: 0, comments: 5, userLiked: false, userDisliked: false },
  { id: 4, title: 'RSZS制度包升级,速度比报送区慢很多,10分钟3张表', category: '产', categoryColor: '#409EFF', tags: ['产品'], answer: '制度包升级速度慢的问题已定位，主要是数据校验逻辑复杂导致，已优化算法提升处理速度。', date: '2025/10/12', customer: '招商银行', views: 145, likes: 67, dislikes: 0, comments: 15, userLiked: false, userDisliked: false },
  { id: 5, title: '可信区校验结果表报文推送失败', category: '产', categoryColor: '#409EFF', tags: ['产品'], answer: '报文推送失败通常由网络异常或配置错误引起，请检查网络连接和推送配置参数。', date: '2025/10/10', customer: '工商银行', views: 112, likes: 34, dislikes: 0, comments: 9, userLiked: false, userDisliked: false },
  { id: 6, title: '如何配置容灾与备份？', category: '技', categoryColor: '#9C27B0', tags: ['技术'], answer: '系统提供完整的容灾备份方案，支持主备切换、数据同步、定时备份等功能。', date: '2025/10/08', customer: '建设银行', views: 89, likes: 28, dislikes: 0, comments: 6, userLiked: false, userDisliked: false },
  { id: 7, title: '系统性能如何优化？', category: '技', categoryColor: '#9C27B0', tags: ['性能优化'], answer: '系统支持多种性能优化策略，包括数据库索引优化、缓存机制、负载均衡等。', date: '2025/10/05', customer: '农业银行', views: 76, likes: 19, dislikes: 0, comments: 4, userLiked: false, userDisliked: false },
  { id: 8, title: '数据安全如何保障？', category: '业', categoryColor: '#409EFF', tags: ['数据安全'], answer: '系统采用多重安全机制，包括数据加密、访问控制、审计日志等，确保数据安全。', date: '2025/10/03', customer: '交通银行', views: 94, likes: 31, dislikes: 0, comments: 7, userLiked: false, userDisliked: false },
  { id: 9, title: '系统部署需要哪些环境？', category: '技', categoryColor: '#9C27B0', tags: ['部署'], answer: '系统支持Linux、Windows等操作系统，需要JDK 1.8+、数据库、应用服务器等环境。', date: '2025/10/01', customer: '民生银行', views: 101, likes: 42, dislikes: 0, comments: 10, userLiked: false, userDisliked: false },
  { id: 10, title: '如何实现数据同步？', category: '数', categoryColor: '#FF6A00', tags: ['数据同步'], answer: '系统提供实时同步和定时同步两种模式，支持增量同步和全量同步。', date: '2025/09/28', customer: '光大银行', views: 82, likes: 25, dislikes: 0, comments: 5, userLiked: false, userDisliked: false },
  { id: 11, title: '系统支持哪些接口协议？', category: '技', categoryColor: '#9C27B0', tags: ['接口'], answer: '系统支持RESTful API、WebService、消息队列等多种接口协议。', date: '2025/09/25', customer: '华夏银行', views: 115, likes: 38, dislikes: 0, comments: 11, userLiked: false, userDisliked: false },
  { id: 12, title: '如何进行系统监控？', category: '技', categoryColor: '#9C27B0', tags: ['监控'], answer: '系统提供完善的监控功能，包括性能监控、日志监控、告警通知等。', date: '2025/09/22', customer: '平安银行', views: 108, likes: 36, dislikes: 0, comments: 9, userLiked: false, userDisliked: false },
]
