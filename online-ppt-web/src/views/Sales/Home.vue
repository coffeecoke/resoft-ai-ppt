...
import { Filter, Document, VideoPlay, MagicStick, Download } from '@element-plus/icons-vue'
...
const openBrandItem = (item) => {
  ...
  if (item.type === 'video') {
    ...
    // 如果是PPT或PDF，可以打开PPT对话框
    openPpt({ id: item.id, title: item.title, thumbnail: item.thumbnail, tag: item.tag || '公共版' })
  }
}
...
const questions = [
  { id: 1, title: '融鑫一表通支持哪些数据库?', category: '数', categoryColor: '#FF6A00', tags: ['国产化', '数据库'], answer: '数据库支持mysql、Oracle[11gR1、12cR2]、DB2、达梦。', date: '2025/10/20', customer: '渤海银行', views: 123, likes: 123, comments: 12, userLiked: false, userDisliked: false },
  { id: 2, title: '如何建立数据治理机制?', category: '业', categoryColor: '#409EFF', tags: ['数据治理'], answer: '建立数据治理机制需要从组织架构、制度规范、技术平台等多个维度进行规划和实施。', date: '2025/10/18', customer: '北京银行', views: 98, likes: 45, comments: 8, userLiked: false, userDisliked: false },
  { id: 3, title: 'RSZS可信区个性化分支1.4与公司合版', category: '技', categoryColor: '#9C27B0', tags: ['技术'], answer: 'RSZS可信区个性化分支1.4版本与公司合版已实现功能对接，支持个性化配置和统一管理。', date: '2025/10/15', customer: '上海银行', views: 67, likes: 23, comments: 5, userLiked: false, userDisliked: false },
  { id: 4, title: 'RSZS制度包升级,速度比报送区慢很多,10分钟3张表', category: '产', categoryColor: '#409EFF', tags: ['产品'], answer: '制度包升级速度慢的问题已定位，主要是数据校验逻辑复杂导致，已优化算法提升处理速度。', date: '2025/10/12', customer: '招商银行', views: 145, likes: 67, comments: 15, userLiked: false, userDisliked: false },
  { id: 5, title: '可信区校验结果表报文推送失败', category: '产', categoryColor: '#409EFF', tags: ['产品'], answer: '报文推送失败通常由网络异常或配置错误引起，请检查网络连接和推送配置参数。', date: '2025/10/10', customer: '工商银行', views: 112, likes: 34, comments: 9, userLiked: false, userDisliked: false },
  ...
  { id: 8, title: '数据安全如何保障？', category: '业', categoryColor: '#409EFF', tags: ['数据安全'], answer: '系统采用多重安全机制，包括数据加密、访问控制、审计日志等，确保数据安全。', date: '2025/10/03', customer: '交通银行', views: 94, likes: 31, comments: 7, userLiked: false, userDisliked: false },
