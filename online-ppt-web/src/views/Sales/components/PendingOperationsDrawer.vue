    ...
    <template #header>
      <div class="drawer-header">
        <div class="drawer-title">
          ...
          待操作列表
          <span class="drawer-count">({{ pendingList.length }})</span>
        </div>
      </div>
    </template>
    ...
    <div class="drawer-content">
      ...
      <div v-else>
        <div class="batch-actions">
          <el-button type="primary" @click="handleBatchAnalyze" :disabled="pendingList.length === 0">
            <i class="ri-magic-stick-line"></i>
            批量AI分析
          </el-button>
          <el-button type="success" @click="handleBatchDownload" :disabled="pendingList.length === 0">
            <i class="ri-download-line"></i>
            批量合并下载
          </el-button>
          <el-button @click="handleClear" :disabled="pendingList.length === 0">
...
const pendingList = computed(() => {
  return pendingStore.pendingList
})

// 初始化selected属性
watch(() => pendingStore.pendingList, (newList) => {
...
const handleBatchDownload = () => {
  ...
  pendingStore.batchDownload(selectedItems)
  ElMessage.success(`开始批量合并下载 ${selectedItems.length} 个项目`)
}
</script>
